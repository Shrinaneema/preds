...
def predict():
    ...
    if request.method == "POST":
       ...
       data = pd.read_excel("C://Users//shrina.neema//Desktop//Stryker_Preprocessed_data//Stryker//converted.xlsx")
       print(data)
       ...
       fig = px.line(final_df,x="date", y=['Label','DowntimeInHours'],title='machine'+'_'+machine+'_'+'Shift'+'_'+Shift+'_'+'Downtime Descripption'+'_'+DowntimeDesctiption, template = 'plotly_dark')
       fig.show() 
